...
add wave -noupdate /tb_main_module/s
...
add wave -noupdate -radix binary /tb_main_module/carry_as
add wave -noupdate -radix binary /tb_main_module/a_gt_b
add wave -noupdate -radix binary /tb_main_module/a_lt_b
add wave -noupdate -radix binary /tb_main_module/a_eq_b
add wave -noupdate -radix unsigned /tb_main_module/ab_and
add wave -noupdate -radix unsigned /tb_main_module/s_m
add wave -noupdate -radix binary /tb_main_module/done
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {88240 ps} 0}
...
update
WaveRestoreZoom {0 ps} {315808 ps}
